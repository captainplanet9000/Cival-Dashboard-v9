-- Missing Critical Tables for Trading Dashboard
-- Run this migration to add essential tables for full functionality

-- 1. Orders table for tracking all order types
...
-- 2. Risk metrics table for real-time risk monitoring
...
-- 3. Alerts table for system notifications
...
-- 4. Exchange connections for multi-exchange support
...
-- 5. Backtest results for strategy optimization
...
-- 6. Audit logs for compliance and debugging
...
CREATE INDEX idx_risk_metrics_type ON risk_metrics(metric_type);
