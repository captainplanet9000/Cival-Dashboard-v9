-- Agent Ecosystem Database Indexes - FINAL FIXED VERSION
-- Run this AFTER fixing the column types
-- This version fixes the scheduled jobs syntax
...
-- ============================================================================
-- SCHEDULED JOBS (if pg_cron is available) - FIXED SYNTAX
-- ============================================================================
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pg_cron') THEN
        ...
        -- Clean old data (runs weekly) - Fixed multi-line syntax
        PERFORM cron.schedule(
            'cleanup-old-data',
            '0 2 * * 0',
