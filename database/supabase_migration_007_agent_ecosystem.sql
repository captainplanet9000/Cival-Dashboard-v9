-- Comprehensive Agent Ecosystem Database Schema
...
-- Core table indexes (no dependencies)
...
-- Agent-dependent table indexes (create after agents table)
...
-- Agent state indexes (create last due to FK dependency)
-- Only create if the table and columns exist
DO $$
BEGIN
